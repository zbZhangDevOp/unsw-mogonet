"""
Helper function file for main_biomarker.py
Inherited from original MOGOENT study
"""
...
# Compute feature importance via difference in F-value by including/excluding each feature in prediction
def cal_feat_imp(data_folder, model_folder, view_list, num_class):
    ...
    for i in range(len(featname_list)):
        print(f"Running repetition {model_folder[-1]} for omics {i}")
...
# Summarize feature importance as obtained from feat_imp_list
